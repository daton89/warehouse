...
const controller = {
  read(req, res) {
    ...
    Article.paginate(query, options).then(rest.respondWithResult(res)).catch(rest.handleCatch(res))
  },
  ...
  create(req, res) {
    ...
    Article.create(req.body).then(rest.respondWithResult(res, 201)).catch(rest.handleCatch(res))
  },
